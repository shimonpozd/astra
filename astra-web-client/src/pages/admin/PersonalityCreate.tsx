...
const PersonalityCreate: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Create New Personality</h1>
          <p className="text-muted-foreground">Define a new personality for the AI assistant</p>
        </div>
      </div>
      ...
      <div className="flex justify-end gap-4">
        ...
        <Button onClick={handleCreate} disabled={saving || !formData.id}>
