...
async def translate_handler(request: TranslateRequest):
    ...
    if not system_prompt:
        ...
        raise HTTPException(status_code=500, detail="Translator system prompt not configured.")

    user_prompt = f"Hebrew Text:\n```\n{request.hebrew_text}\n```"
    ...
    async def stream_llm_response():
        ...
        try:
            ...
            # Yield a user-facing error message as part of the stream
